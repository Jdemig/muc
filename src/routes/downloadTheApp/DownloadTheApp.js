...
import logoUrl from '../../../public/square-logo-small.png';
    ...
    return (
      <div className={s.root}>
        ...
        <div className={s.googleContainer}>
          <a className={s.googleLink} href='https://play.google.com/store/apps/details?id=com.muc.app&hl=en&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img className={s.googleImg} alt='Get it on Google Play' src={googleUrl}/></a>
        </div>

        <div className={s.appleContainer}>
          <a className={s.appleLink} href='https://itunes.apple.com/us/app/meetupcannabis/id1227107838?mt=8' ><img className={s.appleImg} alt='Download on the App Store' src={appleUrl} /></a>
        </div>
